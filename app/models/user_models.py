...
class TrainedModel(db.Model):
    ...
    project_id = db.Column(db.Integer(), db.ForeignKey('projects.id', ondelete='CASCADE'))
    name = db.Column(db.Unicode(255), nullable=False, server_default=u'', unique=False)
    mtype = db.Column(db.Unicode(30), nullable=False, server_default=u'', unique=False)
    created_at = db.Column(db.DateTime, default=datetime.datetime.utcnow)
    path = db.Column(db.Unicode(255), nullable=False, server_default=u'', unique=False)
    mname = db.Column(db.Unicode(255), nullable=False, server_default=u'', unique=False)
    cname = db.Column(db.Unicode(255), nullable=True, unique=False)
